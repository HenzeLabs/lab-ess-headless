...
export default function Header({
  ...
  // Listen for cart updates and refresh the badge count from /api/cart
  useEffect(() => {
    async function refreshCount() {
      try {
        ...
        setLiveCartCount(json.cart?.totalQuantity ?? 0);
      } catch {
        // noop
      }
    }
                          ...
                          <div className="flex flex-col md:flex-row items-center justify-center md:justify-start space-y-2 md:space-y-0 md:space-x-3 text-center md:text-left">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-muted-foreground">
                                We stand by our products and aim for your
