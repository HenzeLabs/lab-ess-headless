...
export default function AnnouncementBar({ message }: AnnouncementBarProps) {
  ...
  return (
    <div className="w-full bg-[hsl(var(--brand))] text-white text-sm font-semibold py-2 px-4 flex items-center justify-center tracking-wide z-[100]" aria-live="polite">
